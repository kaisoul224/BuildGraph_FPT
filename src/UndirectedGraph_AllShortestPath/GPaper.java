...
public class GPaper extends JPanel {
    ...
    public int findVertexByValue(int value) {
        for (int i = 0; i < vertices.size(); i++) {
        ...
        if (selectedEdgeIndex == -1) {
            try {
                this.edgeValue = Integer.parseInt(JOptionPane.showInputDialog(this,
                        "Please enter the value for this edge", "1"));
...
//        System.out.println("To: " + to);
    ...
    public void removeVertex(int index) {
        //remove all edge that has start vertex or end equal to the remove vertex
    ...
    void BFS() {
        traversalReset();
        try {
            int startVertex = Integer.parseInt(JOptionPane.showInputDialog(this,
                    "Please enter the start vertex for BFS Traversal", "0"));
            int fromVertex;
    ...
    void Prim() {
        ...
        for (int i = 0; i < NumberOfVertices; i++) {
            ...
            if (currentVertex == -1){
                ...
                //=> khong tim thay cay khung co trong so nho nhat
    ...
    void Dijkstra() {
        DijkstraReset();
        int startVertex = Integer.parseInt(JOptionPane.showInputDialog(this,
                    "Please enter the start vertex", "0"));
        int endVertex = Integer.parseInt(JOptionPane.showInputDialog(this,
                    "Please enter the end vertex", (NumberOfVertices) - 1 + ""));
        ...
        if (isGraphConnected){
            ...
            dijkstraMessage = "The length if the shortest path from " + startVertex + " to " + endVertex
